...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($input_title)) {
        ...
        $_SESSION['title_err'] = "<div class='alert alert-danger mb-0 text-center'>title için  fazla karakter kullandınız. Max: 150kr</div>";
    } else {
    ...
    if (empty($input_description)) {
        ...
        $_SESSION['description_err'] = "<div class='alert alert-danger mb-0 text-center'> açıklama için  az karakter kullandınız. Min: 11kr</div>";
    } else {
                ...
                <div class="card-body">
                    <form action="blog-create.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                class="form-control <?php echo (!empty($title_err)) ? 'is-invalid' : '' ?>" name="title"
                                id="title" value="<?php echo $title ?>">
